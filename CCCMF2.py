...
model_file_name = "./deepsea02.hdf5";
result_file_name = "./deepsea02.res";
...
fwr.close();
'''
fwr = open("deepsea02-fpr.txt", 'w')
fwr.write(str(false_positive_rate))
fwr.close();


fwr = open("deepsea02-tpr.txt", 'w')
fwr.write(str(true_positive_rate))
fwr.close();


fwr = open("deepsea02-precision.txt", 'w')
fwr.write(str(precision))
fwr.close();


fwr = open("deepsea02-recall.txt", 'w')
