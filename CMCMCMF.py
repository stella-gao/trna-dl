...
model_file_name = "./cnn0302.hdf5";
result_file_name = "./cnn0302.res";
...
fwr.close();
'''
fwr = open("cnn0302-fpr.txt", 'w')
fwr.write(str(false_positive_rate))
fwr.close();


fwr = open("cnn0302-tpr.txt", 'w')
fwr.write(str(true_positive_rate))
fwr.close();


fwr = open("cnn0302-precision.txt", 'w')
fwr.write(str(precision))
fwr.close();


fwr = open("cnn0302-recall.txt", 'w')
