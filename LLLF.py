...
model_file_name = "./rnn03.hdf5";
result_file_name = "./rnn03.res";
...
fwr.close();
'''
fwr = open("rnn03-fpr.txt", 'w')
fwr.write(str(false_positive_rate))
fwr.close();


fwr = open("rnn03-tpr.txt", 'w')
fwr.write(str(true_positive_rate))
fwr.close();


fwr = open("rnn03-precision.txt", 'w')
fwr.write(str(precision))
fwr.close();


fwr = open("rnn03-recall.txt", 'w')
