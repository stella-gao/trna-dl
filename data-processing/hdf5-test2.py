...
#file_name = 'human'
file_name_true = 'pos-test2'
file_name_false = 'neg-test2'
...
import h5py
h5f = h5py.File('test2.hdf5', 'w')
h5f.create_dataset('x_test', data=train_seqs)
h5f.create_dataset('y_test', data=train_scores)
h5f.close()
