...
model_file_name = "./cnn-rnn01.hdf5";
result_file_name = "./cnn-rnn01.res";
...
fwr.close();
'''
fwr = open("cnn-rnn01-fpr.txt", 'w')
fwr.write(str(false_positive_rate))
fwr.close();


fwr = open("cnn-rnn01-tpr.txt", 'w')
fwr.write(str(true_positive_rate))
fwr.close();


fwr = open("cnn-rnn01-precision.txt", 'w')
fwr.write(str(precision))
fwr.close();


fwr = open("cnn-rnn01-recall.txt", 'w')
