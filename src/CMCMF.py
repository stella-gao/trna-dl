...
model_file_name = "./cnn0202.hdf5";
result_file_name = "./cnn0202.res";
...
fwr.close();
'''
fwr = open("cnn0202-fpr.txt", 'w')
fwr.write(str(false_positive_rate))
fwr.close();


fwr = open("cnn0202-tpr.txt", 'w')
fwr.write(str(true_positive_rate))
fwr.close();


fwr = open("cnn0202-precision.txt", 'w')
fwr.write(str(precision))
fwr.close();


fwr = open("cnn0202-recall.txt", 'w')
