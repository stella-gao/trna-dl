...
model_file_name = "./cnn01.hdf5";
result_file_name = "./cnn01.res";
...
fwr.close();
'''
fwr = open("cnn01-fpr.txt", 'w')
fwr.write(str(false_positive_rate))
fwr.close();


fwr = open("cnn01-tpr.txt", 'w')
fwr.write(str(true_positive_rate))
fwr.close();


fwr = open("cnn01-precision.txt", 'w')
fwr.write(str(precision))
fwr.close();


fwr = open("cnn01-recall.txt", 'w')
