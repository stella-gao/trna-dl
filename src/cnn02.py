...
model_file_name = "./cnn02.hdf5";
result_file_name = "./cnn02.res";
...
fwr.close();
'''
fwr = open("cnn02-fpr.txt", 'w')
fwr.write(str(false_positive_rate))
fwr.close();


fwr = open("cnn02-tpr.txt", 'w')
fwr.write(str(true_positive_rate))
fwr.close();


fwr = open("cnn02-precision.txt", 'w')
fwr.write(str(precision))
fwr.close();


fwr = open("cnn02-recall.txt", 'w')
