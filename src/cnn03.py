...
model_file_name = "./cnn03.hdf5";
result_file_name = "./cnn03.res";
...
fwr.close();
'''
fwr = open("cnn03-fpr.txt", 'w')
fwr.write(str(false_positive_rate))
fwr.close();


fwr = open("cnn03-tpr.txt", 'w')
fwr.write(str(true_positive_rate))
fwr.close();


fwr = open("cnn03-precision.txt", 'w')
fwr.write(str(precision))
fwr.close();


fwr = open("cnn03-recall.txt", 'w')
