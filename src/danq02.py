...
model_file_name = "./danq02.hdf5";
result_file_name = "./danq02.res";
...
fwr.close();
'''
fwr = open("danq02-fpr.txt", 'w')
fwr.write(str(false_positive_rate))
fwr.close();


fwr = open("danq02-tpr.txt", 'w')
fwr.write(str(true_positive_rate))
fwr.close();


fwr = open("danq02-precision.txt", 'w')
fwr.write(str(precision))
fwr.close();


fwr = open("danq02-recall.txt", 'w')
