...
model_file_name = "./dnn01.hdf5";
result_file_name = "./dnn01.res";
...
#model.add(LSTM(16, input_shape=(4,134)))
#model.add(Dropout(0.4))
#model.add(LSTM(16, return_sequences=False))
#model.add(Dropout(0.4))
model.add(Dense(64, input_shape=(134,4,), activation='relu'))
...
fwr.close();
'''
fwr = open("dnn01-fpr.txt", 'w')
fwr.write(str(false_positive_rate))
fwr.close();


fwr = open("dnn01-tpr.txt", 'w')
fwr.write(str(true_positive_rate))
fwr.close();


fwr = open("dnn01-precision.txt", 'w')
fwr.write(str(precision))
fwr.close();


fwr = open("dnn01-recall.txt", 'w')
