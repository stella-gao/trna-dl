...
model_file_name = "./rnn01.hdf5";
result_file_name = "./rnn01.res";
...
model.add(LSTM(32, input_shape=(134, 4)))
...
fwr.close();
'''
fwr = open("rnn01-fpr.txt", 'w')
fwr.write(str(false_positive_rate))
fwr.close();


fwr = open("rnn01-tpr.txt", 'w')
fwr.write(str(true_positive_rate))
fwr.close();


fwr = open("rnn01-precision.txt", 'w')
fwr.write(str(precision))
fwr.close();


fwr = open("rnn01-recall.txt", 'w')
