...
model_file_name = "./vgg01.hdf5";
result_file_name = "./vgg01.res";
...
fwr.close();
'''
fwr = open("vgg01-fpr.txt", 'w')
fwr.write(str(false_positive_rate))
fwr.close();


fwr = open("vgg01-tpr.txt", 'w')
fwr.write(str(true_positive_rate))
fwr.close();


fwr = open("vgg01-precision.txt", 'w')
fwr.write(str(precision))
fwr.close();


fwr = open("vgg01-recall.txt", 'w')
